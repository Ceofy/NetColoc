...
def main(seed_gene_file, seed_gene_file_delimiter, num_reps, alpha, minimum_bin_size, interactome_file,
                   interactome_uuid, ndex_server, ndex_user, ndex_password, out_name, save_z_scores, save_final_heat,
                   save_random_final_heats):
  netprop_zscore(
    seed_gene_file, seed_gene_file_delimiter=seed_gene_file_delimiter, num_reps=num_reps, alpha=alpha,
    minimum_bin_size=minimum_bin_size, interactome_file=interactome_file, interactome_uuid=str(interactome_uuid),
    ndex_server=ndex_server, ndex_user=ndex_user, ndex_password=ndex_password, out_name=out_name,
    save_z_scores=save_z_scores, save_final_heat=save_final_heat, save_random_final_heats=save_random_final_heats
  )
